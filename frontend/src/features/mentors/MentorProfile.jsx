...
import {
  ArrowLeft, Briefcase, BookOpen, Send,
  CheckCircle, User, Star, Tag
} from 'lucide-react';
...
.mp-request-btn:hover:not(:disabled) {
...
export default function MentorProfile() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const existing = requestsRes.data.find(
          (r) => r.senior?._id === mentorId || r.senior === mentorId
        );
  ...
  const handleRequest = async () => {
    setRequesting(true);
    try {
      await api.post('/requests', { seniorId: mentorId, message: '' });
    ...
    <>
      ...
      <div className="mp-page">
        <div className="mp-inner">
          <button className="mp-back-btn" onClick={() => navigate('/mentors')}>
          ...
          {loading ? (
            ...
            <div className="mp-hero">
              ...
              <div style={{ flex: 1 }}>
                ...
                <div className="mp-skeleton-box" style={{ height: 44, width: 160 }} />
              </div>
            </div>
          ) : mentor ? (
            <>
              ...
              <div className="mp-hero">
                ...
                <div className="mp-hero-info">
                  ...
                  <div className="mp-role-badge">
                    <Briefcase size={13} /> Senior Mentor
                  </div>
              ...
              <div className="mp-card">
                ...
                <p style={{ color: '#94a3b8', lineHeight: 1.75, fontSize: '0.95rem', margin: 0 }}>
                  {mentor.bio || 'This mentor has not added a biography yet.'}
                </p>
              </div>
              ...
              <div className="mp-card">
                ...
                <p style={{ color: '#64748b', fontSize: '0.9rem', margin: 0 }}>{mentor.email}</p>
              </div>
            </>
          ) : null}
        </div>
